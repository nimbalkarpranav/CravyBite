    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="{{ url('/restaurant/store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col w-full h-32 border-2 border-dashed hover:border-blue-400 hover:bg-gray-50 rounded-lg cursor-pointer transition">
                                <div class="flex flex-col items-center justify-center pt-7">
                                    <i class="fas fa-cloud-upload-alt text-3xl text-gray-400 mb-2"></i>
                                    <p class="text-sm text-gray-500">Upload your restaurant logo</p>
                                </div>
