    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
            ...
            <div style="display: grid; gap: 15px;">
                <div>
                    <label style="display: block; font-weight: 500; margin-bottom: 6px; color: #4a5568;">Restaurant</label>
                    <select name="restaurant_id" required style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 6px; background: #f8fafc;">
